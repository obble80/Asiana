...
namespace Asiana.UI.Extensions
{
    public class Colour
    {
        ...
        static Colour()
        {
            string colourData = @"000000,Black
000080,Navy Blue
0000C8,Dark Blue
0000FF,Blue
000741,Stratos
...
FFFFFF,White";
            ...
            StringReader reader = new StringReader(colourData);
            ...
            do
            {
                ...
                if (line != null)
                {
                    ...
                    colours.Add(elements[1].ToLowerInvariant(), elements[0]);
                }

            } while (line != null);
        }

        public static string NamedColourToHex(string colourName)
        {
            return "#" + colours[colourName.ToLowerInvariant()];
        }
    }
}